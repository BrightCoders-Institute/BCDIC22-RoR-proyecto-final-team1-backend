...
dummyUser = User.create(name: "Yaxkin", email: 'yaxkin@email.com', password: 9876543)
...
dummyReservation = Reservation.create(starting_date: Date.today, ending_date:Date.today+7, total_price:1200, place_id:1, user_id:1)
